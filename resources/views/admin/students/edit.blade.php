...
<div class="max-w-xl">
    ...
    <div class="skeuo-card rounded-2xl overflow-hidden">
        <div class="p-6 border-b border-slate-200 flex items-center justify-between bg-slate-50/50">
            <h3 class="font-extrabold text-slate-800 text-base tracking-tight">Ubah Data Siswa</h3>
            ...
            <div class="flex flex-col sm:flex-row gap-4 items-start">
                @if($student->photo_path)
                    <div class="flex-shrink-0">
                        <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Foto Sekarang</label>
